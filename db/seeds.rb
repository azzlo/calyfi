...
150.times do |counter|
  Student.create!(name: Faker::Name.first_name.capitalize, last_name: Faker::Name.last_name.capitalize, mothers_last_name: Faker::Name.last_name.capitalize, address: Faker::Address.street_address,
                  suburb: Faker::Address.city_prefix, city: Faker::Address.city, state: Faker::Address.state, postal_code: Faker::Address.postcode,
                  birthdate: Faker::Date.birthday(15, 20), sex: ['Masculino', 'Femenino'][rand(0..1)], group_id: Group.all.sample.id,
                  enrollment: Faker::Number.number(10))
end
