...
class CurriculumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curriculum" do
    assert_difference('Curriculum.count') do
      post curriculums_url, params: { curriculum: { name: @curriculum.name, specialty_id: @curriculum.specialty_id, study_cycle_id: @curriculum.study_cycle_id } }
    end
  ...
  test "should update curriculum" do
    patch curriculum_url(@curriculum), params: { curriculum: { name: @curriculum.name, specialty_id: @curriculum.specialty_id, study_cycle_id: @curriculum.study_cycle_id } }
